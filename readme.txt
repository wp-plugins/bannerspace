...
= 1.3.4 =
* Moved options panel into Settings

= 1.3.3 =
* Autoplay option fix

= 1.3.2 =
* Fixed images loaded plugin ref bug when paused
* Nicer loading
...
* Removed shadow image and replaced with CSS

= 1.2.9 =
* Updated jQuery imagesLoaded plugin to v2.0.1

= 1.2.8 =
* Proper script enqueuing 

= 1.2.7 =
* Added play on images loaded option
